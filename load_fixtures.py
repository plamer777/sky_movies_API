"""This unit contains a function and logic to fill up created database"""
...
def load_data(data: List[Dict[str, Any]], model: Type[models.Base]) -> None:
    ...
    :param data: a list of dictionaries with data to create models
    :param model: the SQLAlchemy model to work with the database
    """
    for item in data:
        item['id'] = item.pop('pk')
